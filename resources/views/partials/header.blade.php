    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <div class="container">
                ...
                <button class="btn btn-submit my-2 px-5" type="button" >Cari</button>
            </div> 
        </div>
    </div>
    {{-- Header --}}
           ...
           <div class="row pt-3 pb-3 d-flex align-items-center">
               ...
               <div class="col-md-8 col-sm-12 col-xs-6">
                    <div class="d-flex form-inputs">
                        ...
                        <input class="form-control search" type="text" placeholder="Cari Perumahan Favorit Anda...">
                    </div>
               </div>
               ...
               <div class="col-md-1">
                <button class="btn admin-button" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" aria-controls="exampleModal">
            ...
            <div class="container">
                <div class="row"    >
                    <div class="col-md-12 d-flex justify-content-center">
                        <img src="img/Logo2.png" alt="Logo SPK"/>
                    </div>
                </div>
            </div>
                ...
                <div class="row mx-5">
                    <form>
                        ...
                        <div class="password-container mb-2">
                            <input type="password" class="form-control login" id="exampleInputPassword1" name="password" placeholder="Password">
